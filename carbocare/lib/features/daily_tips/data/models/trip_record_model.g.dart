...
TripRecord _tripRecordDeserialize(
  ...
  object.carbonKg = reader.readDouble(offsets[0]);
...
extension TripRecordQueryWhereSort
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterWhere> anyDate() {
    return QueryBuilder.apply(this, (query) {
...
extension TripRecordQueryWhere
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterWhereClause> dateEqualTo(
      DateTime date) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterWhereClause> dateNotEqualTo(
      DateTime date) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterWhereClause> dateGreaterThan(
    DateTime date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterWhereClause> dateLessThan(
    DateTime date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterWhereClause> dateBetween(
    DateTime lowerDate,
    DateTime upperDate, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TripRecordQueryFilter
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterFilterCondition> carbonKgEqualTo(
    double value, {
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterFilterCondition> carbonKgLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterFilterCondition> carbonKgBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterFilterCondition> dateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'date',
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterFilterCondition> dateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterFilterCondition> dateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterFilterCondition> dateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TripRecordQuerySortBy
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> sortByCarbonKg() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carbonKg', Sort.asc);
    });
  }

  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> sortByCarbonKgDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carbonKg', Sort.desc);
    });
  }

  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TripRecordQuerySortThenBy
  ...
  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> thenByCarbonKg() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carbonKg', Sort.asc);
    });
  }

  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> thenByCarbonKgDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carbonKg', Sort.desc);
    });
  }

  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<TripRecord, TripRecord, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }
...
extension TripRecordQueryWhereDistinct
  ...
  QueryBuilder<TripRecord, TripRecord, QDistinct> distinctByCarbonKg() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'carbonKg');
    });
  }

  QueryBuilder<TripRecord, TripRecord, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
...
extension TripRecordQueryProperty
  ...
  QueryBuilder<TripRecord, double, QQueryOperations> carbonKgProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'carbonKg');
    });
  }

  QueryBuilder<TripRecord, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
